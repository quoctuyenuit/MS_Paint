...
{
    class PolygonShape : MyPaint.Shape.Frame.FrameSpace
    {
        ...
        public override void updateShape(Point _curPoint, Tools.DrawingProperties _properties, Tools.DrawingSetting.MoseStatus _mouseStatus)
        {
            this.drawingProperties = _properties;
            if(_mouseStatus == Tools.DrawingSetting.MoseStatus.Down)
            {
                tempPoint = _curPoint;
